 ...
 * 可以左右拉伸的Layout
 */
public class HorizontalFlingLayout1 extends LinearLayout {
    ...
    public HorizontalFlingLayout1(Context context) {
        this(context, null);
    }

    public HorizontalFlingLayout1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HorizontalFlingLayout1(Context context, AttributeSet attrs, int defStyleAttr) {
